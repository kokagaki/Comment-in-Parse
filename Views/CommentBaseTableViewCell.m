...
#import "CommentUtility.h"

@interface CommentBaseTableViewCell () {
...
@implementation CommentBaseTableViewCell
@synthesize mainView;
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        horizontalTextSpace =  [CommentBaseTableViewCell horizontalTextSpaceForInsetWidth:cellInsetWidth];
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.cellInsetWidth != 0) {
        [CommentUtility drawSideDropShadowForRect:mainView.frame inContext:UIGraphicsGetCurrentContext()];
    }
}
...
#pragma mark - CommentBaseTextCell

/* Static helper to get the height for a cell if it had the given name and content */
+ (CGFloat)heightForCellWithName:(NSString *)name contentString:(NSString *)content {
    return [CommentBaseTableViewCell heightForCellWithName:name contentString:content cellInsetWidth:0];
}
...
+ (CGFloat)heightForCellWithName:(NSString *)name contentString:(NSString *)content cellInsetWidth:(CGFloat)cellInset {
    ...
    NSString *paddedString = [CommentBaseTableViewCell padString:content withFont:[UIFont systemFontOfSize:13] toWidth:nameSize.width];
    CGFloat horizontalTextSpace = [CommentBaseTableViewCell horizontalTextSpaceForInsetWidth:cellInset];
...
- (void)setContentText:(NSString *)contentString {
    ...
    if (self.user) {
        CGSize nameSize = [self.nameButton.titleLabel.text sizeWithFont:[UIFont boldSystemFontOfSize:13] forWidth:nameMaxWidth lineBreakMode:UILineBreakModeTailTruncation];
        NSString *paddedString = [CommentBaseTableViewCell padString:contentString withFont:[UIFont systemFontOfSize:13] toWidth:nameSize.width];
...
- (void)setCellInsetWidth:(CGFloat)insetWidth {
    ...
    horizontalTextSpace = [CommentBaseTableViewCell horizontalTextSpaceForInsetWidth:insetWidth];
    [self setNeedsDisplay];
}
...
- (id<CommentBaseTableViewCellDelegate>)delegate {
    return (id<CommentBaseTableViewCellDelegate>)delegate;
}

- (void)setDelegate:(id<CommentBaseTableViewCellDelegate>)aDelegate {
