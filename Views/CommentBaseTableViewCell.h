...
@protocol CommentBaseTableViewCellDelegate;
...
/*!
 The protocol defines methods a delegate of a BaseTextCell should implement.
 */
@protocol CommentBaseTableViewCellDelegate <NSObject>
@optional
 ...
 */
- (void)cell:(CommentBaseTableViewCell *)cellView didTapUserButton:(PFUser *)aUser;
